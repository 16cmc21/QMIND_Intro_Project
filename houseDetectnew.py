...
if __name__ == "__main__":
    model_path = 'path to graph' # path to frozen_interface_graph.pb
    ...
    for count in range(1835, 2041):
        ...
        imageIn = '/path_to_images/{}_streetview.jpeg'.format(count) # path to housing images, put this in a different folder than working directory
        ...
        if classes[index] == 20:
            ...
            cv2.imwrite('saving/path' + str(count) +'_streetview' + '.jpeg', new_img)
            cv2.waitKey()
            new_count += 1
    print(indices)
